...
const TABLE_HEAD = [
  ...
  { id: "topup", label: "Top Up Coins", alignRight: false },
...
export default function Users() {
  ...
  const topUpModal = async (id) => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/v1/user/wallet/topup`, {
      method: "Post",
  ...
  const updateTotalAmount = (users) => {
    const totalAmount = users.reduce((total, user) => total + user.wallet.topup, 0);
    ...
    <Page title="User">
      <Container maxWidth="xl">
        <Stack
          ...
          mb={4.5}
        >
          <Typography variant="h4">Top Up Users</Typography>
        </Stack>
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{wallet.topup}</TableCell>
